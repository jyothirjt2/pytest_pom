...
class AddCustomer:
    ...
    listtxtbx_role_xpath = '//div[@class="input-group-append input-group-required"]'
    ...
    def setrole(self,role):
        ...
        if role == 'Registered':
            ...
            self.driver.find_element(By.XPATH,'//*[@id="SelectedCustomerRoleIds_taglist"]'
                                              '//span[@aria-label="delete"]').click()
            self.listitem = self.driver.find_element(By.XPATH,self.list_guests_xpath)
        else:
            self.listitem = self.driver.find_element(By.XPATH, self.list_guests_xpath)

        time.sleep(2)
        # self.listitem.click()   is not wrking
    ...
    def setadmincomment(self,comment):
        self.driver.find_element(By.XPATH,self.txtfield_admincomment_xpath).send_keys(comment)
    def clicksave(self):
